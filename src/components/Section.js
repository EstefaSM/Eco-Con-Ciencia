    ...
    return (         
        <div className='data'>
            <div className='container-fluid'>
                ...
                <div className="card mb-4" style={{ maxWidth: '25rem', margin: '0 10px', backgroundColor: '#bcd0c1'}}>
                ...
                <div className="card mb-3" style={{ maxWidth: '25rem', margin: '0 10px', backgroundColor: '#bcd0c1' }}>
                ...
                <div className="card-header bg-transparent border-dark text-center"><strong>Uso de los datos</strong></div>
                    <div className="card-body text-dark">
                        <p className="card-text text-center"><small>Utilizamos técnicas estadísticas y herramientas de análisis avanzadas para procesar los datos y detectar tendencias, patrones y anomalías significativas. Nuestro equipo de expertos en análisis ambiental interpreta los resultados obtenidos, contextualizando la información.</small></p>
                    </div>
                </div>
                </div>
            </div>
